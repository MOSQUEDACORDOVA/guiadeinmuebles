...
if (defined('THEME_MODULE_SCREEN_NAME')) {
    Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers\Fronts'], function () {
        Theme::registerRoutes(function () {
            ...
            Route::get('feed/properties', [PublicController::class, 'getPropertyFeeds'])->name('feeds.properties');
            Route::get('feed/projects', [PublicController::class, 'getProjectFeeds'])->name('feeds.projects');
